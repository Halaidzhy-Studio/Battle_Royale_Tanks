...
// Легкая и быстрая имплементация парсtра
// Не кидает ошибки. Если в файле карты ошибка, класс об этом не скажет.
// Если проект станет больше, можно написать надежную и безопасную реализацию.
